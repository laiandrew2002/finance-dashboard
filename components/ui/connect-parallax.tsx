  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-8 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        Your <br /> Personal Finance Assistant
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        FinTrack’s AI analyzes your spending habits and suggests ways to save
        money, reduce unnecessary expenses, and plan better for the future.
      </p>
    </div>
  );
};
